...
export interface IExampleClient {
    ...
    /**
     * @generated from protobuf rpc: CommonUnaryCall(common.CommonRequest) returns (common.CommonReply);
     */
    commonUnaryCall(input: CommonRequest, options?: RpcOptions): UnaryCall<CommonRequest, CommonReply>;
    /**
     * @generated from protobuf rpc: CommonStreamingCall(common.CommonRequest) returns (stream common.CommonReply);
     */
    commonStreamingCall(input: CommonRequest, options?: RpcOptions): ServerStreamingCall<CommonRequest, CommonReply>;
}
/**
 * @generated from protobuf service example.Example
 */
export class ExampleClient implements IExampleClient, ServiceInfo {
    ...
    commonUnaryCall(input: CommonRequest, options?: RpcOptions): UnaryCall<CommonRequest, CommonReply> {
        ...
        return stackIntercept<CommonRequest, CommonReply>("unary", this._transport, method, opt, input);
    }
    /**
     * @generated from protobuf rpc: CommonStreamingCall(common.CommonRequest) returns (stream common.CommonReply);
     */
    commonStreamingCall(input: CommonRequest, options?: RpcOptions): ServerStreamingCall<CommonRequest, CommonReply> {
        ...
        return stackIntercept<CommonRequest, CommonReply>("serverStreaming", this._transport, method, opt, input);
    }
}
